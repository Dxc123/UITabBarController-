...
-(void)setUpChildViewControllers{
    ...
    [self setUpOneChildViewController:homeVc image:[UIImage imageNamed:@"icon_tabbar_home"]  selectedImage:[UIImage imageNamed:@"icon_tabbar_home_active"]  title:@"首页"];
    XXGradeViewController *gradeVC=[[XXGradeViewController alloc] init];
    [self setUpOneChildViewController:gradeVC image:[UIImage imageNamed:@"icon_tabbar_subscription"] selectedImage:[UIImage imageNamed:@"icon_tabbar_subscription_active"] title:@"积分"];
    XXFriendsViewController *friendsVC=[[XXFriendsViewController alloc] init];
    [self setUpOneChildViewController:friendsVC image:[UIImage imageNamed:@"icon_tabbar_notification"] selectedImage:[UIImage imageNamed:@"icon_tabbar_notification_active"] title:@"朋友圈"];
    XXMeViewController *meVC=[[XXMeViewController alloc] init];
    [self setUpOneChildViewController:meVC image:[UIImage imageNamed:@"icon_tabbar_me"] selectedImage:[UIImage imageNamed:@"icon_tabbar_me_active"] title:@"账户"];
